...
export class ContainerComponent {
  ...
  colors: string[] = ['blue', 'black', 'white', 'yellow', 'cyan', 'green', 'purple', 'red'];
  ...
  onAceptarClick(): void {
    ...
    this.visualizadorMensaje = 'Se ha aceptado sus datos'; // Mostrar mensaje en el visualizador
  }
  ...
  onCancelarClick(): void {
    ...
    this.visualizadorMensaje = 'Cancelado'; // Cambiar el mensaje
  }
